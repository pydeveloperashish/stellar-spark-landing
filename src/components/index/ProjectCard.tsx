  ...
  return (
    ...
    >
      <CardHeader className="pb-2">
        <div 
          className="h-96 -mt-6 -mx-6 mb-4 relative overflow-hidden rounded-2xl group-hover:from-purple-800/30 group-hover:to-blue-800/30 transition-all duration-500"
